...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BorderGoApp.config = new ARConfig(this.getApplicationContext()); // instantiate in the first view class so that config gets the correct context to access text assets.
