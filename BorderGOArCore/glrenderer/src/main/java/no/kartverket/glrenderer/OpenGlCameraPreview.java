...
public class OpenGlCameraPreview {
    ...
    public OpenGlCameraPreview() {
        ...
        //float[] vtmp = {0.0f, -1.0f, -1.0f, -1.0f, 0.0f, 1.0f, -1.0f, 1.0f};
        // Vertices texture coords.
        float[] ttmp = {1.0f, 1.0f, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 0.0f};
        //float[] ttmp = {0.5f, 2f, 0.0f, 2f, 0.5f, -1f, 0.0f, -1f};
        // Indices.
        short[] itmp = {0, 2, 1, 3};
    ...
    public void updateTextureUv(int rotation){
        // TODO implement ARCore equivalent
        /*float[] textureCoords =
    ...
    public float[] getTextureCoordsCopy(){
        return mMesh.getTextureCoordsCopy();
    }
